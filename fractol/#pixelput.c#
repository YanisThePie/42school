...
/*   Updated: 2016/05/24 14:51:38 by yismail          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_color(t_env *env)
{
	...
	if (env->frm.i <= env->frm.iteration_max / 4 &&
		env->frm.i >= env->frm.iteration_max / 5)
	{
		ft_put_pixel_img(env, 0xFE0EEB);
		return (0);
	}
	if (env->frm.i < env->frm.iteration_max / 5 &&
		env->frm.i >= env->frm.iteration_max / 6)
	{
